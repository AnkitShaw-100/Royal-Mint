        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-lg text-gray-900 bg-gray-50 p-3 rounded-lg">{user?.firstName}</p>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-gray-700">Last Name</label>
                  <p className="text-lg text-gray-900 bg-gray-50 p-3 rounded-lg">{user?.lastName}</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-lg">
                  <p className="text-lg text-gray-900 flex-1">{user?.primaryEmailAddress?.emailAddress}</p>
                  <Button
                    size="sm"
                    variant="ghost"
                    onClick={() => handleCopyEmail(user?.primaryEmailAddress?.emailAddress)}
                  >
                    {copiedEmail ? (
          ...
          <Card className="border-2">
            ...
            <CardContent className="space-y-6">
              {/* Clerk ID */}
              <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-700">Clerk ID</label>
                <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-lg">
                  <p className="text-sm text-gray-600 font-mono flex-1">{user?.id}</p>
                  <Button
                    size="sm"
                    variant="ghost"
              ...
              <div className="space-y-2">
                ...
                <p className="text-lg text-gray-900 bg-gray-50 p-3 rounded-lg">{createdDate}</p>
              </div>
