...
function TransactionDetail() {
  ...
  const isDebit =
    transaction.fromAccount?.user?._id?.toString() === user.id ||
    transaction.fromAccount?.user?.toString() === user.id;
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50/30 to-indigo-50/20 flex items-center justify-center">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 md:py-8 space-y-6 w-full">
        {/* Main Transaction Card */}
        <Card className="border-2 shadow-lg">
          <CardHeader className="space-y-4 bg-linear-to-r from-blue-50 to-indigo-50 border-b">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                <div
                  className={`p-4 rounded-full ${isDebit ? "bg-red-100" : "bg-green-100"}`}
                >
                  {isDebit ? (
                    <ArrowUpRight
                      className={`w-8 h-8 ${isDebit ? "text-red-600" : "text-green-600"}`}
                    />
                  ) : (
              ...
              <Badge
                className={`text-lg px-4 py-2 ${statusColor[transaction.status]}`}
              >
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-lg border border-gray-200">
                    <p className="text-sm text-gray-600 font-mono flex-1 break-all">
                      {transaction._id}
                    </p>
                    <Button
                      size="sm"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-800 mt-1">
                        This transaction has been successfully processed and
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-yellow-800 mt-1">
                        This transaction is being processed. Please check back
                        shortly for updates.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-800 mt-1">
                        This transaction could not be completed. Please contact
