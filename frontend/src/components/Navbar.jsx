...
export function Navbar() {
  ...
  const navItems = [
    ...
    { name: 'Dashboard', path: '/dashboard', icon: LayoutDashboard, shortName: 'Dashboard' },
    { name: 'Accounts', path: '/accounts', icon: Wallet, shortName: 'Accounts' },
    { name: 'Transfer', path: '/transfer', icon: ArrowLeftRight, shortName: 'Transfer' },
    { name: 'Transactions', path: '/transactions', icon: Receipt, shortName: 'Txns' },
    { name: 'History', path: '/history', icon: HistoryIcon, shortName: 'History' },
  ]
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center h-14 md:h-16 gap-4">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg md:text-xl font-bold text-gray-900 leading-tight">Royal Mint</h1>
          ...
          <div className="flex gap-2 md:gap-3 items-center ml-auto">
            ...
            <SignedOut>
              <SignInButton mode="modal">
                <Button variant="ghost" className="text-xs md:text-sm text-gray-700 p-1 md:px-3">
                  Sign In
                </Button>
              </SignInButton>
            ...
            <SignedIn>
              <UserButton 
                ...
                appearance={{
                  elements: {
                    avatarBox: "w-8 h-8 md:w-10 md:h-10 ring-2 ring-gray-200 hover:ring-blue-500 transition-all"
                  }
                }}
              />
            </SignedIn>
        ...
        {mobileMenuOpen && (
          <SignedIn>
            <nav className="lg:hidden border-t border-gray-200 bg-gradient-to-b from-white to-gray-50 animate-in fade-in slide-in-from-top-2">
